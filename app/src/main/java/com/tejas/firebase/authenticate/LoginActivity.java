package com.tejas.firebase.authenticate;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public PhoneAuthProvider.ForceResendingToken forceResend = null;
    private VerificationState mVerificationState;
    private Handler mHandler;
    @VisibleForTesting
    CompletableProgressDialog mProgressDialog;
    private String mVerificationId;
    private static final String APP_NAME = "saffronart";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otp_button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                vertifyotpcode(mVerificationId, mPasswordView.getText().toString());
            }
        });
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                        ...
                        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, mEmailView.getText().toString());
                        bundle.putString("Type", "smssent");
                        bundle.putString("Response", "success");
                        mFirebaseAnalytics.logEvent("otpsent", bundle);
                    ...
                    public void onVerificationFailed(FirebaseException ex) {
                        Log.e("onVerificationFailed", ex.getMessage());
                        Bundle bundle = new Bundle();
                        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, mEmailView.getText().toString());
                        bundle.putString("Type", "smssent");
                    ...
                    public void onCodeSent(@NonNull String verificationId,
                        ...
                        Log.e("onCodeSent", verificationId + "forceresend token" + forceResendingToken);
                        Bundle bundle = new Bundle();
                        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, mEmailView.getText().toString());
                        bundle.putString("Type", "onCodeSent");
    ...
    private void vertifyotpcode(String verificationId, String otpCode) {
        signIn(PhoneAuthProvider.getCredential(verificationId, otpCode));
    }
...
//        return FirebaseAuth.getInstance(FirebaseApp.getInstance(APP_NAME));
...
//                        Log.e("onSuccess", authResult.getAdditionalUserInfo().getProviderId());
